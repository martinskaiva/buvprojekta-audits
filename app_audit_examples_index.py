...
#
# [app]# app_audit_examples_index.py
# ------------------------------------------------------------
...
def infer_family_and_scenario(row: pd.Series) -> Tuple[str, str, str]:
    ...
    issue_mapping = {
        ...
        # v1.5: pēdējie Z_unclassified mappingi no 2026-07-13 indeksa.
        "automātikas signālu apzīmējuma kļūda": ("K_solution_or_graphic_clarity", "SC-K02_unclear_reference_or_designation", "Neskaidra atsauce, apzīmējums vai mezgla/elementa identifikācija"),
        "designation_inconsistency": ("K_solution_or_graphic_clarity", "SC-K02_unclear_reference_or_designation", "Neskaidra atsauce, apzīmējums vai mezgla/elementa identifikācija"),
        "language/document_title": ("A_text_language", "SC-A01_spelling_or_wording_error", "Drukas, locījuma vai formulējuma kļūda"),
        "missing_document_fields": ("N_completeness_or_missing_content", "SC-N03_document_content_missing", "Dokumenta saturs nav pilnīgs vai neatbilst satura rādītājam"),
        "nepabeigts telpas/laukuma apzīmējums": ("N_completeness_or_missing_content", "SC-N01_incomplete_or_unfinished_text", "Nepabeigts vai pārrauts teksts"),
        "official_note_language_error": ("A_text_language", "SC-A01_spelling_or_wording_error", "Drukas, locījuma vai formulējuma kļūda"),
        "orientation_text_error": ("A_text_language", "SC-A01_spelling_or_wording_error", "Drukas, locījuma vai formulējuma kļūda"),
        "placeholder_text": ("N_completeness_or_missing_content", "SC-N01_incomplete_or_unfinished_text", "Nepabeigts vai pārrauts teksts"),
        "signal_traceability": ("J_cross_document_traceability", "SC-J01_not_traceable_between_documents", "Izsekojamības problēma starp dokumentiem"),
        "technical_conflict": ("G_material_type_model", "SC-G02_technical_parameter_mismatch", "Tehniska parametra vai risinājuma neatbilstība"),
        "technical_note_language_error": ("A_text_language", "SC-A01_spelling_or_wording_error", "Drukas, locījuma vai formulējuma kļūda"),
        "technical_parameter_check": ("G_material_type_model", "SC-G02_technical_parameter_mismatch", "Tehniska parametra vai risinājuma neatbilstība"),
        "technical_term_error": ("A_text_language", "SC-A02_technical_term_error", "Tehniskā termina kļūda"),
